...
const ArticlePage = ({ article }) => {
  ...
  // Sostituisce i link testuali con HTML "grezzo" (un bottone) per consentire a rehypeRaw di renderizzarli
  ...
  const contenutoParagrafi = article.contenuto.split('/n/n').map((paragrafo, index) => {
    ...
    // Trasforma i link in bottone
    const replacedParagraph = convertUrlsToButtons(paragrafo);
  ...
  return (
    <div className={styles.article}>
      <Head>
        ...
        <meta
          property="og:url"
          content={`https://www.il-blog-di-michele-vacca.it/article/${article.id}-${sanitizeFilename(article.slug)}`}
        />
      ...
      <div className={styles.contenuto}>
        ...
        <div className={styles.orario}>
          <p className={styles.orarioEst}>
            <strong>{article.date}</strong> alle <strong>{article.ora}</strong>
          </p>
        </div>
        ...
        <div className={styles.social}>
          <SocialIcon
            ...
            url="https://www.tiktok.com/@michele.vacca.blog?_t=8mrJ15DgGkS&_r=1"
            target="_blank"
          ...
          <SocialIcon
            ...
            bgColor="#000000"
            style={{ height: 34, width: 34 }}
            url="https://www.youtube.com/channel/UC_a5LsGJWmwSCDoV0SbD9AQ"
            target="_blank"
            rel="noopener noreferrer"
          />
          <SocialIcon
            ...
            bgColor="#000000"
            style={{ height: 34, width: 34 }}
            url="https://www.instagram.com/blogdimichelevacca/?igsh=MXBiMHh4NnB2NGtubQ%3D%3D"
            target="_blank"
            rel="noopener noreferrer"
          />
          <SocialIcon
            ...
            bgColor="#000000"
            style={{ height: 34, width: 34 }}
            url="https://www.facebook.com/profile.php?id=100063728582740"
            target="_blank"
            rel="noopener noreferrer"
          />
        </div>
