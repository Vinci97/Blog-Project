        ...
        <div className={styles.Footer}>
            ...
            <div className={styles.footerSocial}>
                ...
                <div className={styles.footerIconeSocial}>
                    ...
                    <SocialIcon className={styles.icon} network="instagram" bgColor="rgba(0, 0, 0, 0)"style={{ height: 34, width: 34 }}url="https://www.instagram.com/blogdimichelevacca/?igsh=MXBiMHh4NnB2NGtubQ%3D%3D"target="_blank"rel="noopener noreferrer"/>
                    <SocialIcon className={styles.icon} network="facebook" bgColor="rgba(0, 0, 0, 0)"style={{ height: 34, width: 34}} url="https://www.facebook.com/profile.php?id=100063728582740"target="_blank"rel="noopener noreferrer"/>
                </div>
            </div>
        </div>
    )
